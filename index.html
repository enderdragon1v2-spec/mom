...
<head>
    ...
    <meta name="description" content="Trang quà tặng 20/10 dành cho Ngày Phụ nữ Việt Nam: mở hộp quà, đọc thư yêu thương và xem ảnh quà kèm nhạc nền.">
    <!-- Open Graph for Facebook -->
    <meta property="og:title" content="Quà 20/10 - Ngày Phụ nữ Việt Nam">
    <meta property="og:description" content="Mở hộp quà, đọc thư yêu thương và xem ảnh quà kèm nhạc nền. Chúc mừng Ngày Phụ nữ Việt Nam 20/10!">
    ...
    <meta name="twitter:description" content="Mở hộp quà, đọc thư yêu thương và xem ảnh quà kèm nhạc nền.">
    <meta name="twitter:image" content="giftimage.png">
    <link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400;600;700&display=swap" rel="stylesheet">
        <!-- Thêm các thư viện phục vụ scene phong thư -->
    ...
    <style>
        * {
        ...
        body {
            ...
            position: relative;
            overflow: hidden;
            -webkit-touch-callout: none; /* iOS: hạn chế callout */
            -webkit-user-select: none;   /* iOS: hạn chế chọn chữ gây zoom */
            -ms-user-select: none;
            user-select: none;
        }
        .background-image{
        ...
        /* Đăng ký biến để phối hợp xoay + nhịp tim mà không ghi đè transform */
        @property --scale {
            syntax: '<number>';
            inherits: false;
            initial-value: 1;
        }
        /* Đăng ký biến hoạt ảnh cho nắp hộp (Safari iOS cần để interpolate) */
        @property --lidY {
        ...
        /* Trái tim: dùng biến --rot cho góc xoay sẵn có, --scale cho nhịp tim */
        .heart1,
        .heart2{
        ...
        /* Đặt góc xoay cho từng trái tim */
        .heart1{ --rot: 0deg; }
        .heart2{ --rot: -19deg; }

        /* Nhịp đập tim: thay đổi --scale để không xung đột với rotate */
        @keyframes heartbeat {
            0%, 100% { --scale: 1; }
            25% { --scale: 1.06; }
            50% { --scale: 0.98; }
        ...
        /* Hộp quà giữa màn hình */
        .boxgift{
            position: absolute;
            top: 60%;
            left: 50%;
            /* Dùng biến để không xung đột với animation wiggle */
            --tx: 0; /* translateX phụ */
            --ty: 0; /* translateY phụ */
            --rot: 0deg; /* góc xoay phụ */
            transform: translate(-50%, -50%) translate(var(--tx), var(--ty)) rotate(var(--rot)) scale(var(--scale, 1));
            z-index: 3;
            width: min(12vw, 110px);
            aspect-ratio: 1 / 1; /* khung tương đối để xếp ảnh */
            pointer-events: auto;
            cursor: pointer;
        }
        .boxgift .box-gift{
        ...
        /* Thân hộp đặt ở đáy khung */
        .boxgift .base{
            bottom: 0;
            z-index: 1;
        }
        /* Nắp hộp chồng lên thân, hơi trùng xuống một chút để khít hơn */
        .boxgift .lid{
            bottom: 60%; /* điều chỉnh để khớp với ảnh thực tế */
            z-index: 2;
            /* trạng thái đóng */
            transform: translateX(-50%) translateY(0) rotate(0deg);
            transform-origin: center; /* trục xoay hợp lý cho iOS */
        }

        /* Pulse (phóng to/thu nhỏ) nhẹ nhàng cho hộp quà khi chưa mở */
        @keyframes giftPulse {
            0%, 100% { --scale: 1; }
            50% { --scale: 1.08; }
        }
        ...
        /* Mở nắp hộp khi click: animate trực tiếp transform để tương thích iOS */
        ...
        /* (Đã bỏ confetti theo yêu cầu) */

        /* Lơ lửng nhẹ cho các cụm hoa/góc */
        @keyframes floatY {
            0% { transform: translateY(0); }
            100% { transform: translateY(-10px); }
        }

        /* Vào trang mượt: mờ dần */
        @keyframes fadeIn {
            from { opacity: 0; }
            to { opacity: 1; }
        }
        ...
        /* Khi đã tải: áp hiệu ứng vào trang và chuyển động */
        ...
        /* Cả hai trái tim đập cùng nhịp, bắt đầu sau 1.1s để khớp kết thúc fadeIn */
        ...
        @media (prefers-reduced-motion: reduce){
            /* chỉ giảm chuyển động nền/cụm hoa, giữ pulse hộp và heartbeat */
            .background-image,
            .corner-image,
            .corner-image-right{ animation: none !important; }
        }

        /* Ẩn mọi thứ trừ hình nền khi đã mở hộp sau 1s */
        ...
        /* Trạng thái ẩn hẳn scene thư, chỉ còn nền */
        body.final-hide #letterScene{ display: none !important; }
        /* Lớp phủ ảnh cuối (ẩn mặc định) */
        #giftOverlay{
        ...
        /* Loader trung tâm khi chờ dữ liệu backend */
        ...
        /* ---------- SCENE PHONG THƯ (chèn từ file thứ hai) ---------- */
        /* Gói toàn bộ scene trong #letterScene để dễ bật/tắt */
        ...
        /* Nút mũi tên tiếp tục trong dialog thư */
...
<body>   
    ...
    <!-- anh nen -->
    <img src="/Users/hoangquocviet/Downloads/bg.png" alt="Ảnh nen" class="background-image">

    <!-- Ảnh ở góc dưới trái -->
    <img src="/Users/hoangquocviet/Downloads/b3.png" alt="Ảnh b3" class="corner-image bottom-left">
    <img src="/Users/hoangquocviet/Downloads/b3.png" alt="Ảnh b3" class="corner-image bottom-left-right">
     <!-- Ảnh ở góc dưới phải -->
    <img src="/Users/hoangquocviet/Downloads/b4.png" alt="Ảnh b4" class="corner-image-right bottom-right">
    <!-- Annh trai tim -->
    <img src="/Users/hoangquocviet/Downloads/b6.png" alt="Ảnh b4" class="heart1">
    <img src="/Users/hoangquocviet/Downloads/b5.png" alt="Ảnh b5" class="heart2">
    
    <h1 class="headline">Chúc mừng Ngày Phụ nữ Việt Nam!</h1>

    <!-- SCENE PHONG THƯ: ẩn sẵn, chỉ hiển thị sau khi mở hộp quà -->
    <div id="letterScene">
    ...
    " />
            ...
            <div class="boxLetter">
                ...
                <div class="formLetter">
                    ...
                    <div class="wrapperLetter">
                        <div class="giftbox">
                            <div class="img">
                                <img src="/Users/hoangquocviet/Downloads/giftbox.png" alt="">
                            </div>
                        </div>
                        <div class="textLetter">
                            ...
                            <div class="heartAnimation">
                                <img src="/Users/hoangquocviet/Downloads/heartAnimation.gif" alt="">
                            </div>
                        </div>
                        <div class="mewmew1">
                            <img src="/Users/hoangquocviet/Downloads/mewmew.gif" alt="">
                        </div>
                        <div class="mewmew2">
                            <img src="/Users/hoangquocviet/Downloads/mewmew.gif" alt="">
                        </div>
                    ...
                    <button class="letterNextBtn" title="Tiếp tục" aria-label="Tiếp tục">
        ...
        <audio id="bgm" src="/Users/hoangquocviet/Downloads/ERIK-x-FREAKY-x-BENNY-_Yêu-Bền-Bỉ_-_-Official-MV.mp3" preload="auto" loop></audio>
    </div>
    <!-- Lớp phủ hiển thị ảnh quà -->
    <div id="giftOverlay">
        <img src="/Users/hoangquocviet/Downloads/Ảnh màn hình 2025-10-2.png" alt="Quà">
        <!-- Animations phủ lên ảnh quà -->
        <img class="anim heartBottom" src="/Users/hoangquocviet/Downloads/heartAnimation.gif" alt="heart animation">
        <img class="anim traiTimTop" src="/Users/hoangquocviet/Downloads/giftraitim.gif" alt="gif trái tim">
    ...
    <div class="boxgift" id="giftBox">
     <img src="/Users/hoangquocviet/Downloads/nap.png" alt="Nắp hộp" class="box-gift lid">
     <img src="/Users/hoangquocviet/Downloads/hop.png" alt="Thân hộp" class="box-gift base">
        </div>
    ...
    <script>
      // --------- Dữ liệu mock thay thế API ---------
      // Biến toàn cục để typing sử dụng dữ liệu mock
      window.textLetterH2 = 'Chúc mừng Ngày Phụ nữ Việt Nam!';
      window.textLetterP = 'Gửi đến mẹ người phụ nữ tuyệt vời nhất trong cuộc đời con. Cảm ơn mẹ đã luôn là nguồn động viên, là điểm tựa vững chắc và là niềm vui trong cuộc sống. Chúc mẹ luôn xinh đẹp, hạnh phúc và thành công trong mọi việc. Yêu thương mẹ rất nhiều! 💕';
      window.captionImage = 'Món quà đặc biệt dành tặng mẹ - người phụ nữ tuyệt vời nhất! 🌹';
      
      // Dữ liệu mock
      const mockData = {
        titleLetter: 'Chúc mừng Ngày Phụ nữ Việt Nam!',
        contentLetter: 'Gửi đến mẹ người phụ nữ tuyệt vời nhất trong cuộc đời con. Cảm ơn mẹ đã luôn là nguồn động viên, là điểm tựa vững chắc và là niềm vui trong cuộc sống. Chúc mẹ luôn xinh đẹp, hạnh phúc và thành công trong mọi việc. Yêu thương mẹ rất nhiều! 💕',
        signatureLetter: 'Với tất cả tình yêu thương ❤️',
        music: '/Users/hoangquocviet/Downloads/ERIK-x-FREAKY-x-BENNY-_Yêu-Bền-Bỉ_-_-Official-MV.mp3',
        image: '/Users/hoangquocviet/Downloads/Ảnh màn hình 2025-10-2.png',
        captionImage: 'Món quà đặc biệt dành tặng mẹ - người phụ nữ tuyệt vời nhất! 🌹'
      };
      ...
      (function(){
        ...
        function applyData(data){
          ...
          // Không set nội dung ngay để tránh lộ trước khi typing; chỉ đảm bảo trống
        ...
        // Giả lập thời gian tải để giữ nguyên hiệu ứng
        setTimeout(() => {
          try{
            console.log('Mock data loaded:', mockData);
            // Gán biến cho typing dùng
      ...
      // Kích hoạt trạng thái đã tải để chạy animation vào trang và nhịp tim
      // Đã được xử lý trong phần mock data ở trên, không cần thêm logic ở đây
      // Mở nắp hộp khi click (bỏ confetti)
      (function(){
        ...
        function openBox(){
          ...
          // Phát nhạc ngay khi bấm vào hộp quà (theo tương tác người dùng)
          (function(){
          ...
          // Sau 1 giây, ẩn toàn bộ UI trừ hình nền
          setTimeout(function(){
            document.body.classList.add('hide-ui');
            // Hiển thị scene phong thư
            const scene = document.getElementById('letterScene');
            if(scene){ scene.style.display = 'block'; }
            // Khởi chạy hiệu ứng SVG và logic thư, nhạc nền
            initLetterScene();
          }, 1000);
        }
      ...
      // Ngăn pinch-zoom, double-tap zoom, wheel zoom trên mobile
      (function(){
        function isMobile(){ return /Mobi|Android|iPad|iPhone|iPod/i.test(navigator.userAgent); }
        if(!isMobile()) return;

        // chặn pinch (gesturestart là Safari), và CTRL+wheel
        ...
        // chặn pinch bằng 2 ngón (touchmove với 2 điểm)
        document.addEventListener('touchmove', function(e){
          if(e.touches && e.touches.length > 1){ e.preventDefault(); }
        }, { passive: false });
      })();

      // ------------ Logic cho SCENE PHONG THƯ -------------
      function initLetterScene(){
        try{
          // SVG typing theo đường cong
          ...
          if($){
            ...
            $('.card').off('click').on('click', function(){
              ...
              // Chỉ chạy typing nếu có dữ liệu đã gán từ mock data
              if((window.textLetterH2||'') && (window.textLetterP||'')){
                funcTimeoutLetter();
              }
              // Không phát nhạc ở đây nữa; nhạc đã phát khi bấm hộp quà
            });
            // Ẩn hiện nút mũi tên theo trường image
                ...
                if(overlay){
                  ...
                  if(capEl){
                    ...
                    if(txt.length > 0){
                      ...
                      // nếu trống, ẩn caption để không chiếm chỗ
